...
/**
 * The text area. Field in connected view model must be String.
 * <p>
 ...
 */
public class YTextArea extends JTextArea implements YIModelComponent, YITextComponent {
	...
	public static void setStaticUpper(boolean staticUpper) {
		YTextArea.staticUpper = staticUpper;
	}
	...
	/* (non-Javadoc)
	 * @see fi.mmm.yhteinen.swing.component.YIComponent#addViewListener(fi.mmm.yhteinen.swing.YController, fi.mmm.yhteinen.swing.viewModel)
	 */
	public void addViewListener(final YController controller) {
        this.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent ev) {
            	controller.updateModelAndController(YTextArea.this);
            }
        });
 		this.addKeyListener(new KeyAdapter() {
			public void keyReleased(KeyEvent e) {
				if (keyEventsEnabled) {
					String methodName = YUIToolkit.createMVCMethodName(YTextArea.this, "KeyReleased");
					if (methodName != null) {
